...
const assetUrl = function(asset, type) {
  ...
  // 核心修复：如果是以 '/' 开头的本地绝对路径，或者包含了 'http'，直接原样返回！
  if (str.startsWith('/') || str.indexOf('http') > -1) {
    return str
  }
